...
with_node \
  ...
  --target "/Users/phatnguyen/Document/Ondoing/Irrigration_Farm/ios/Pods/Target Support Files/Pods-Irrigation/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-constants" "expo-device" "expo-file-system" "expo-keep-awake" "expo-router"
